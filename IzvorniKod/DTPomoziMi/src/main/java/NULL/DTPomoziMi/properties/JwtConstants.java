...
public class JwtConstants {
    ...
    public void setJwtCookieName(String jwtCookieName) {
        if(jwtCookieName == null)
            throwException("jwt.cookie.name");
